...
public class TicTacToe {
    ...
    public boolean play(String s) {
        /*
         * Step 2: Fill in here with your own play logic, and replace the return with
         * you own.
         */
        return false;
    }
    ...
    public boolean won() {
        /*
         * Step 5: Fill in the code for the won method. This method should return true
         * if the current player has 3 in-a-row in any row, column or diagonal.
    ...
    public boolean stalemate() {
        /*
         * Step 4: Fill in the code for the stalemate method. It should return true if
         * there are no more places to move on the board. Otherwise, return false return
         * false;
         */
